...
public class MicActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    DatabaseReference MicRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MicRef = FirebaseDatabase.getInstance().getReference().child("Mic");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cartIntent = new Intent(MicActivity.this, CartActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(MicRef, Products.class)
                        .build();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_cart){
            ...
            Intent ordersIntent = new Intent(MicActivity.this, OrdersActivity.class);
            startActivity(ordersIntent);

        } else if(id == R.id.nav_categories){
            Intent loginIntent = new Intent(MicActivity.this, CategoryActivity.class);
            ...
            Intent loginIntent = new Intent(MicActivity.this, SettingsActivity.class);
            startActivity(loginIntent);


        } else if(id == R.id.nav_logout){
            Paper.book().destroy();
            Intent loginIntent = new Intent(MicActivity.this, LoginActivity.class);
            startActivity(loginIntent);
        }
