...
public class VinilActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_cart){
            ...
            Intent ordersIntent = new Intent(VinilActivity.this, OrdersActivity.class);
            startActivity(ordersIntent);

        } else if(id == R.id.nav_categories){
            Intent loginIntent = new Intent(VinilActivity.this, CategoryActivity.class);
            ...
            Intent loginIntent = new Intent(VinilActivity.this, SettingsActivity.class);
            startActivity(loginIntent);


        } else if(id == R.id.nav_logout){
            Paper.book().destroy();
            Intent loginIntent = new Intent(VinilActivity.this, LoginActivity.class);
            startActivity(loginIntent);
        }
