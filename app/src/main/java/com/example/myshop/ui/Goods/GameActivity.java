...
public class GameActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cartIntent = new Intent(GameActivity.this, CartActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(GameRef, Products.class)
                        .build();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_cart){
            ...
            Intent ordersIntent = new Intent(GameActivity.this, OrdersActivity.class);
            startActivity(ordersIntent);

        } else if(id == R.id.nav_categories){
            Intent loginIntent = new Intent(GameActivity.this, CategoryActivity.class);
            ...
            Intent loginIntent = new Intent(GameActivity.this, SettingsActivity.class);
            startActivity(loginIntent);
