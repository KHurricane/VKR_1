...
public class CabelActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    DatabaseReference CabRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CabRef = FirebaseDatabase.getInstance().getReference().child("Cabel");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cartIntent = new Intent(CabelActivity.this, CartActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(CabRef, Products.class)
                        .build();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_cart){
            ...
            Intent ordersIntent = new Intent(CabelActivity.this, OrdersActivity.class);
            startActivity(ordersIntent);

        } else if(id == R.id.nav_categories){
            Intent loginIntent = new Intent(CabelActivity.this, CategoryActivity.class);
            ...
            Intent loginIntent = new Intent(CabelActivity.this, SettingsActivity.class);
            startActivity(loginIntent);


        } else if(id == R.id.nav_logout){
            Paper.book().destroy();
            Intent loginIntent = new Intent(CabelActivity.this, LoginActivity.class);
            startActivity(loginIntent);
        }
