...
public class CustomActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustRef = FirebaseDatabase.getInstance().getReference().child("Custom");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cartIntent = new Intent(CustomActivity.this, CartActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(CustRef, Products.class)
                        .build();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_cart){
            ...
            Intent ordersIntent = new Intent(CustomActivity.this, OrdersActivity.class);
            startActivity(ordersIntent);

        } else if(id == R.id.nav_categories){
            Intent loginIntent = new Intent(CustomActivity.this, CategoryActivity.class);
            ...
            Intent loginIntent = new Intent(CustomActivity.this, SettingsActivity.class);
            startActivity(loginIntent);


        } else if(id == R.id.nav_logout){
            Paper.book().destroy();
            Intent loginIntent = new Intent(CustomActivity.this, LoginActivity.class);
            startActivity(loginIntent);
        }
